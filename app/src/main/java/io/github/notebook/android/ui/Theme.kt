...
object NotebookColors {
    ...
    val AccentTextLight = Color(0xFF745700)
...
private val Light = lightColorScheme(primary=NotebookColors.AccentTextLight,onPrimary=Color.White,primaryContainer=Color(0xFFFFE8A3),onPrimaryContainer=Color(0xFF352800),secondary=NotebookColors.AccentTextLight,onSecondary=Color.White,secondaryContainer=Color(0xFFFFF1C2),onSecondaryContainer=Color(0xFF352800),background=NotebookColors.EditorLight,surface=NotebookColors.ListLight,surfaceVariant=NotebookColors.SidebarLight,outlineVariant=Color(0x14000000))
