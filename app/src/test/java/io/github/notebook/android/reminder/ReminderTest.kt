...
class ReminderTest {
    ...
    @Test fun `private reminder never exposes the note title`(){assertEquals("Notebook 私密提醒",reminderNotificationTitle("绝密会议",true));assertEquals("公开提醒",reminderNotificationTitle("公开提醒",false));assertEquals("Notebook 提醒",reminderNotificationTitle("",false))}
}
