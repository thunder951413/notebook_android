...
class AppUpdaterTest{
    ...
    @Test fun prefersTrustedGithubApiAssetUrl(){val api="https://api.github.com/repos/owner/repo/releases/assets/123";assertEquals(api,preferredAssetUrl(api,"https://github.com/owner/repo/releases/download/v1/app.apk"))}
    @Test fun rejectsUntrustedAssetApiUrl(){val browser="https://github.com/owner/repo/releases/download/v1/app.apk";assertEquals(browser,preferredAssetUrl("http://api.github.com/repos/owner/repo/releases/assets/123",browser));assertEquals(browser,preferredAssetUrl("https://example.com/repos/owner/repo/releases/assets/123",browser));assertEquals(browser,preferredAssetUrl("https://api.github.com/repos/owner/repo/releases/latest",browser))}
    @Test fun distinguishesJsonAndBinaryGithubEndpoints(){assertTrue(isReleaseAssetUrl("https://api.github.com/repos/owner/repo/releases/assets/123"));assertTrue(isReleaseAssetUrl("https://github.com/owner/repo/releases/download/v1/app.apk"));assertFalse(isReleaseAssetUrl("https://api.github.com/repos/owner/repo/releases?per_page=100"))}
}
